...
/**
 * Retrieves last inserted identity columns. This examines global connection
 * values and may not work correctly if the database uses triggers. It will
 * however work correctly in a multi-threaded environment.
 * 
...
public interface IdentityValueLoader extends Closeable {
	...
	/**
	 * Returns the most recently returned value from the specified sequence on the
	 * current connection.
	 * 
	 * @param sequenceName
